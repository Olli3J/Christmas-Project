...
class SceneA extends BaseScene {
  ...
  preload() {
    ...
    //audio
    this.load.audio('music', 'assets/sounds/Blazer Rail.mp3');
    //images
    ...
    //tilemap data
    this.load.tilemapTiledJSON('platform-map', 'assets/platform-christmas.json');
    //player
  ...
  create() {
    ...
    let tiles = this.map.addTilesetImage('platform-tiles', 'tiles');
